...
# A highly rigorous perft test suite using standard, difficult test positions
# and deeper search depths. Passing this suite provides a very high degree
# of confidence in the engine's correctness.
# See: https://www.chessprogramming.org/Perft_Results
PERFT_SUITE = [
    # FEN, depth, nodes
    # Start position to depth 5. A major benchmark.
    # NOTE: This test can take several seconds to run.
    ("rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR w KQkq - 0 1", 5, 4865609),

    # Kiwipete to depth 4. A very complex middlegame position.
    ("r3k2r/p1ppqpb1/bn2pnp1/3PN3/1p2P3/2N2Q1p/PPPBBPPP/R3K2R w KQkq - 0 1", 4, 4085603),

    # Position 3 to depth 5. An endgame position.
    ("8/2p5/3p4/KP5r/1R3p1k/8/4P1P1/8 w - - 0 1", 5, 674624),
    
    # Position 4 to depth 4. Many captures and checks.
    ("r3k2r/Pppp1ppp/1b3nbN/nP6/BBP1P3/q4N2/Pp1P2PP/R2Q1RK1 w kq - 0 1", 4, 422333),

    # Position 5 to depth 4. Tricky promotion and check lines.
    ("rnbq1k1r/pp1Pbppp/2p5/8/2B5/8/PPP1NnPP/RNBQK2R w KQ - 1 8", 4, 2103487),
    
    # A standard tactical position.
